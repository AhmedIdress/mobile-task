...
import 'package:mobile_task/view/update_view.dart';
import 'package:mobile_task/view/welcome_view.dart';
          ...
          ListTile(
            ...
            title: Text(
              controller.fullNameController.text.isEmpty
                  ? controller.fullNameController.text = 'Ahmed Idress'
          ...
          ListTile(
            ...
            title: Text(
              controller.phoneNumberController.text.isEmpty
                  ? controller.phoneNumberController.text = '+201010826486'
          ...
          ListTile(
            ...
            title: Text(
              controller.emailController.text.isEmpty
                  ? controller.emailController.text = 'ahmed@gmail.com'
                ...
                return InkWell(
                  onTap: () {
                    if (index == 0) {
                      ...
                      context.pushReplacement(const WelcomeView());
                      controller.emailController.text = '';
                      controller.phoneNumberController.text = '';
